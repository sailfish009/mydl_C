...
from mydl.modeling import meta_arch
from mydl.modeling.box_regression import Box2BoxTransform
from mydl.modeling.meta_arch.panoptic_fpn import combine_semantic_and_instance_outputs
from mydl.modeling.postprocessing import detector_postprocess, sem_seg_postprocess
from mydl.modeling.roi_heads import keypoint_head
from mydl.structures import Boxes, ImageList, Instances, RotatedBoxes
...
def assemble_rcnn_outputs_by_name(image_sizes, tensor_outputs, force_mask_on=False):
    ...
    to mydl's format (i.e. list of Instances instance).
...
class Caffe2MetaArch(Caffe2Compatible, torch.nn.Module):
    ...
    def __init__(self, cfg, torch_model):
        ...
        Args:
            cfg (CfgNode):
            torch_model (nn.Module): the mydl model (meta_arch) to be
                converted.
        """
        super().__init__()
    ...
    def get_caffe2_inputs(self, batched_inputs):
        ...
        Args:
            batched_inputs (list[dict]): inputs to a mydl model
    ...
    def get_outputs_converter(predict_net, init_net):
        ...
        The returned function has the following signature:
            ...
            def convert(batched_inputs, c2_inputs, c2_results) -> mydl_outputs
        ...
        Where
            ...
            * mydl_outputs: the original output format of the meta arch.
