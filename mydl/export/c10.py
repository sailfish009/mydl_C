...
from mydl.modeling.proposal_generator import rpn
from mydl.modeling.roi_heads.mask_head import mask_rcnn_inference
from mydl.modeling.roi_heads.rotated_fast_rcnn import RotatedFastRCNNOutputs
from mydl.structures import Boxes, ImageList, Instances, Keypoints
...
class Caffe2Boxes(Boxes):
    """
    Representing a list of mydl.structures.Boxes from minibatch, each box
